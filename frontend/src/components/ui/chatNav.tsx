...
const ChatNav = () => {
  ...
  return (
    <motion.div
      ...
      className="sm:w-full w-screen  hover:bg-zinc-800 transition-all ease-in  cursor-pointer duration-200 h-full hover: flex items-center px-[1rem] justify-between"
    >
      ...
      <div className="flex h-full  items-center gap">
        ...
        <i className="ri-search-line hover:bg-zinc-900 hidden  transition-all ease-in duration-200 rounded-full w-[2.5rem] h-[2.5rem] md:flex items-center justify-center"></i>
